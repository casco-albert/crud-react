...
const ShowProducts = () => {
  const url='http://localhost/api-web/productsController.php';
  ...
  const validar = ()=>{
    ...
    if(name.trim() === ''){
        ...
        if(operation === 1){
            ...
            parametros = {id:id.trim(), name:name.trim(), description:description.trim(), price:price}
            metodo = 'PUT';
        }
  ...
  const deleteProduct = (id, name) =>{
    ...
    MySwal.fire({
        title: '¿Estas seguro de eliminar el prodducto'+name+' ?',
        ...
        if(result.isConfirmed){
            ...
            show_alerta('El producto no fue posible eliminar', 'info');
        }
    });
  }
  return (
        ...
        <div className='container-fluid'>
           <div className='row mt-3'>
                <div className='col*md-4 offset-4'>
                    ...
                    <button onClick={()=> openModal(1)} className='btn btn-dark btn-sm' data-bs-toggle="modal" data-bs-target="#modalProducts">
              ...
              <div className='col-12 col-lg-8 offset-0 offset-lg-2'>
                  <div className='table-responsive'>
                      <table className='table table-bordered'>
                          <thead>
                              <tr><th>#</th><th>PRODUCTOS</th><th>DESCRIPCION</th><th>PRECIO</th><th>ACCIONES</th></tr>
                          </thead>
                  ...
                  <div className='modal-content'>
                      ...
                      <div className='modal-body'>
                          ...
                          <div className='input-group mb-3'>
                              ...
                              <input type='text' id='descripcion' className='form-control' placeholder='Descripcion' value={description} onChange={(e) => setDescription(e.target.value)}></input>
                          </div>
                          <div className='input-group mb-3'>
                              <span className='input-group-text'><i className='fa-solid fa-dollar-sign'></i></span>
                              <input type='text' id='precio' className='form-control' placeholder='Precio' value={price} onChange={(e) => setPrice(e.target.value)}></input>
                          </div>
